...
namespace Ringen.Plugin.CsView
{
    public sealed class RegisterPlugin : PluggableBase
    {
        ...
        {
            Type = GetType();
            TransManager.Instance.AddTranslationResource(ResourcesEnum.Ringen_Plugin_CsView_DictPluginMain, "Ringen.Plugin.CsView.Resources.LanguageFiles.DictPluginMain", Assembly.GetExecutingAssembly());
        }
