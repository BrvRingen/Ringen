...
namespace Ringen.Schnittstelle.RDB.Tests.ServiceTests.MannschaftskaempfeTests
{
    ...
    public class GetLigaMitPlatzierungTests
    {
        ...
        {
            Tuple<Liga, List<Tabellenplatzierung>> ligaTuple = _apiMannschaftskaempfe.GetLigaMitPlatzierungAsync("2019", "Oberliga", "Westfalen").Result;
        ...
        {
            Tuple<Liga, List<Tabellenplatzierung>> ligaTuple = _apiMannschaftskaempfe.GetLigaMitPlatzierungAsync("2020", "Oberliga", "").Result;
