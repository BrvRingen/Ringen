...
namespace Ringen.Plugin.CsEditor
{
	...
	{
		Ringen_Plugin_CsEditor_DictPluginMain,
	}
	...
	public class TranslateExtension : Ringen.Core.TranslationManager.TranslateExtension
	{
		...
		{
			Key = key.ToString();
			Resource = ResourcesEnum.Ringen_Plugin_CsEditor_DictPluginMain.ToString();
		}
	...
	public enum DictPluginMain
	{
		...
		/// Verspäteter Start und die Pause müss nicht mehr eingetragen werden. Diese werden den Kämpfen entnommen.
		/// </summary>
		EditorCommentHint,
	}
